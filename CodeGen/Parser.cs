		...
		public void parseSettings (string path)
		{
			...
			while ((s = reader.ReadLine()) != null) {
				...
				if (m.Success) {
					...
					if (type.Equals("STRING") || type.Equals("BOOL") || type.Equals("UINT32"))
						Console.WriteLine("DEFINE_FREERDP_SETTINGS_ACCESSORS_{0}({1}) /* {2} */", type, name, number);
